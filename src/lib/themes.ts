  ...
  bespokeThemes: {
    'SET_1_PALETTE_0': {
      ...
      light: {
        ...
        '--primary': '206.5 70.2% 55.5%',
        '--primary-foreground': '0 0% 100%',
        '--secondary': '213.3 5.3% 53.1%',
        '--secondary-foreground': '215.4 16.3% 26.9%',
        '--muted': '213.3 5.3% 53.1%',
        '--muted-foreground': '213.3 5.3% 43.1%',
        '--accent': '142.1 63.2% 49%',
        '--accent-foreground': '0 0% 100%',
        '--destructive': '0 80.6% 61.4%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '213.3 5.3% 83.1%',
        '--input': '213.3 5.3% 83.1%',
        '--ring': '206.5 70.2% 55.5%',
      },
      dark: {
        '--background': '215.4 16.3% 16.9%',
        '--foreground': '0 0% 97.3%',
        '--card': '215.4 16.3% 20.9%',
        '--card-foreground': '0 0% 97.3%',
        '--popover': '215.4 16.3% 20.9%',
        '--popover-foreground': '0 0% 97.3%',
        '--primary': '206.5 70.2% 65.5%',
        '--primary-foreground': '215.4 16.3% 16.9%',
        '--secondary': '213.3 5.3% 43.1%',
        '--secondary-foreground': '0 0% 97.3%',
        '--muted': '213.3 5.3% 43.1%',
        '--muted-foreground': '213.3 5.3% 63.1%',
        '--accent': '142.1 63.2% 59%',
        '--accent-foreground': '215.4 16.3% 16.9%',
        '--destructive': '0 80.6% 51.4%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '213.3 5.3% 33.1%',
        '--input': '213.3 5.3% 33.1%',
        '--ring': '206.5 70.2% 65.5%',
      },
    },
    'SET_1_PALETTE_1': {
      swatchColor: '#6C5CE7',
      light: {
        '--background': '246 100% 97.3%',
      ...
      dark: {
        '--background': '250 24% 16.3%',
        '--foreground': '246 100% 97.3%',
        '--card': '244 19.4% 21%',
        '--card-foreground': '246 100% 97.3%',
        '--popover': '244 19.4% 21%',
        '--popover-foreground': '246 100% 97.3%',
        '--primary': '246 78% 65%',
        '--primary-foreground': '250 24% 16.3%',
        '--secondary': '244 15.6% 65.3%',
        '--secondary-foreground': '246 100% 97.3%',
        '--muted': '244 15.6% 65.3%',
        '--muted-foreground': '244 15.6% 85.3%',
        '--accent': '186 100% 40%',
        '--accent-foreground': '250 24% 16.3%',
        '--destructive': '0 100% 70%',
        '--destructive-foreground': '250 24% 16.3%',
        '--border': '244 15.6% 35.3%',
        '--input': '244 15.6% 35.3%',
        '--ring': '246 78% 65%',
      },
    },
    'SET_1_PALETTE_2': {
      swatchColor: '#FF7F50',
      light: {
        '--background': '25 83% 94.7%',
        '--foreground': '24 24.1% 23.7%',
        '--card': '0 0% 100%',
        '--card-foreground': '24 24.1% 23.7%',
        '--popover': '0 0% 100%',
        '--popover-foreground': '24 24.1% 23.7%',
        '--primary': '16.4 100% 65.7%',
        '--primary-foreground': '24 24.1% 13.7%',
        '--secondary': '0 0% 63.9%',
        '--secondary-foreground': '24 24.1% 23.7%',
        '--muted': '0 0% 63.9%',
        '--muted-foreground': '0 0% 43.9%',
        '--accent': '120 60.6% 49%',
        '--accent-foreground': '0 0% 100%',
        '--destructive': '0 62% 48.4%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '0 0% 83.9%',
        '--input': '0 0% 83.9%',
        '--ring': '16.4 100% 65.7%',
      ...
      dark: {
        '--background': '24 24.1% 13.7%',
        '--foreground': '25 83% 94.7%',
        '--card': '24 24.1% 17.7%',
        '--card-foreground': '25 83% 94.7%',
        '--popover': '24 24.1% 17.7%',
        '--popover-foreground': '25 83% 94.7%',
        '--primary': '16.4 100% 65.7%',
        '--primary-foreground': '24 24.1% 13.7%',
        '--secondary': '0 0% 43.9%',
        '--secondary-foreground': '25 83% 94.7%',
        '--muted': '0 0% 43.9%',
        '--muted-foreground': '0 0% 63.9%',
        '--accent': '120 60.6% 59%',
        '--accent-foreground': '24 24.1% 13.7%',
        '--destructive': '0 62% 58.4%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '0 0% 33.9%',
        '--input': '0 0% 33.9%',
        '--ring': '16.4 100% 65.7%',

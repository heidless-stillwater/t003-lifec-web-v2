  ...
  bespokeThemes: {
    ...
    'SET_1_PALETTE_4': {
      ...
      dark: {
        ...
        '--foreground': '216 33% 96%',
        '--card': '215 25% 15%',
        '--card-foreground': '216 33% 96%',
        '--popover': '215 25% 15%',
        '--popover-foreground': '216 33% 96%',
        '--primary': '249 81% 67%',
        '--primary-foreground': '0 0% 100%',
        '--secondary': '210 16% 43%',
        '--secondary-foreground': '216 33% 96%',
        '--muted': '210 16% 43%',
        '--muted-foreground': '210 16% 63%',
        '--accent': '180 100% 41%',
        '--accent-foreground': '0 0% 100%',
        '--destructive': '356 75% 54%',
        '--destructive-foreground': '0 0% 100%',
    ...
    'SET_1_PALETTE_5': {
      ...
      dark: {
        '--background': '0 0% 13%',
        '--foreground': '180 50% 99%',
        '--card': '0 0% 13%',
        '--card-foreground': '180 50% 99%',
        '--popover': '0 0% 13%',
        '--popover-foreground': '180 50% 99%',
        '--primary': '197 71% 73%',
        '--primary-foreground': '0 0% 13%',
        '--secondary': '0 0% 25%',
        '--secondary-foreground': '180 50% 99%',
        '--muted': '0 0% 25%',
        '--muted-foreground': '0 0% 60%',
        '--accent': '350 100% 88%',
    ...
    'SET_1_PALETTE_8': {
      ...
      dark: {
        ...
        '--muted': '248 76% 59%',
        '--muted-foreground': '210 100% 87%',
        '--accent': '180 100% 50%',
        '--accent-foreground': '240 17% 15%',
        '--destructive': '16 100% 50%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '240 16% 30%',
        '--input': '240 16% 30%',

...
const skySerenityTheme = {
  ...
  dark: {
    '--background': '230 18% 11%',
    '--foreground': '224 71% 95%',
    '--card': '228 15% 16%',
    '--card-foreground': '224 71% 95%',
    '--popover': '228 15% 16%',
    '--popover-foreground': '224 71% 95%',
    '--primary': '259 86% 78%',
  ...
  bespokeThemes: {
    'SET_1_PALETTE_OceanBlue': {
      ...
      light: {
        ...
        '--foreground': '215 63% 21%',
        '--card': '0 0% 100%',
        '--card-foreground': '215 63% 21%',
        '--popover': '0 0% 100%',
        '--popover-foreground': '215 63% 21%',
        '--primary': '203 100% 36%',
        '--primary-foreground': '0 0% 100%',
        '--secondary': '202 74% 96%',
        '--secondary-foreground': '215 63% 21%',
        '--muted': '202 74% 96%',
      ...
      dark: {
        ...
        '--primary': '203 100% 70%',
        '--primary-foreground': '215 63% 21%',
        '--secondary': '214 48% 26%',
        '--secondary-foreground': '201 100% 98%',
        '--muted': '214 48% 26%',
        '--muted-foreground': '201 10% 60%',
        '--accent': '142 71% 65%',
        '--accent-foreground': '215 63% 21%',
        '--destructive': '0 72% 51%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '214 48% 26%',
        '--input': '214 48% 26%',
    ...
    'SET_1_PALETTE_Sunrise': {
      swatchColor: '#FF6F61',
      light: {
        '--background': '28 100% 97%',
        '--foreground': '16 67% 24%',
        '--card': '0 0% 100%',
        '--card-foreground': '16 67% 24%',
        '--popover': '0 0% 100%',
        '--popover-foreground': '16 67% 24%',
        '--primary': '5 100% 69%',
        '--primary-foreground': '16 67% 24%',
        '--secondary': '27 100% 95%',
        '--secondary-foreground': '16 67% 24%',
        '--muted': '27 100% 95%',
        '--muted-foreground': '24 10% 50%',
        '--accent': '120 61% 34%',
        '--accent-foreground': '0 0% 100%',
        '--destructive': '0 72% 51%',
        '--destructive-foreground': '0 0% 100%',
    ...
    'SET_1_PALETTE_MysticPurple': {
      swatchColor: '#6A0572',
      light: {
        '--background': '295 67% 97%',
        '--foreground': '266 93% 20%',
        '--card': '0 0% 100%',
        '--card-foreground': '266 93% 20%',
        '--popover': '0 0% 100%',
        '--popover-foreground': '266 93% 20%',
        '--primary': '295 90% 24%',
        '--primary-foreground': '0 0% 100%',
        '--secondary': '295 67% 97%',
        '--secondary-foreground': '266 93% 20%',
        '--muted': '295 67% 97%',
        '--muted-foreground': '266 20% 50%',
        '--accent': '55 96% 50%',
        '--accent-foreground': '266 93% 20%',
      ...
      dark: {
        '--background': '266 93% 20%',
        '--foreground': '295 67% 97%',
        '--card': '266 80% 25%',
        '--card-foreground': '295 67% 97%',
        '--popover': '266 80% 25%',
        '--popover-foreground': '295 67% 97%',
        '--primary': '271 91% 65%',
        '--primary-foreground': '266 93% 20%',
        '--secondary': '266 80% 25%',
        '--secondary-foreground': '295 67% 97%',
        '--muted': '266 80% 25%',
        '--muted-foreground': '295 10% 60%',
        '--accent': '55 96% 70%',
        '--accent-foreground': '266 93% 20%',
        '--destructive': '25 80% 70%',
        '--destructive-foreground': '0 0% 100%',
        '--border': '266 80% 25%',
        '--input': '266 80% 25%',
        '--ring': '271 91% 65%',

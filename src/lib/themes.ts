...
export const appThemes = {
  ...
  bespokeThemes: {
    ...
    'SET_1_PALETTE_1': {
      ...
      dark: {
        '--background': '246 39% 14%',
        '--foreground': '246 100% 94%',
        '--card': '246 33% 20%',
        '--card-foreground': '246 100% 94%',
        '--popover': '246 33% 20%',
        '--popover-foreground': '246 100% 94%',
        '--primary': '246 78% 65%',
        '--primary-foreground': '246 39% 14%',
        '--secondary': '245 28% 64%',
        '--secondary-foreground': '246 100% 94%',
        '--muted': '245 28% 64%',
        '--muted-foreground': '245 28% 84%',
        '--accent': '186 100% 40%',
        '--accent-foreground': '246 39% 14%',
        '--destructive': '0 100% 70%',
        '--destructive-foreground': '246 39% 14%',
        '--border': '245 28% 34%',
        '--input': '245 28% 34%',
        '--ring': '246 78% 65%',
      },
